				...
				else if (WeapSkinSettingsMode == 1)
				{
					...
					if (WItem->Skin.striker_enable)
					{
						...
						if (StickersMode == 0)
						{
							...
							X1Gui().ListBoxHeader(XorStr("##StickerSerials"), Vec2(453, 326));
						...
						else if (StickersMode == 1)
						{
							if (GP_Skins->AllSkinsLoaded)
							{
								X1Gui().ListBoxHeader(XorStr("##SortStickerSerials"), Vec2(71, 363));
								...
								{
									TextEdit("Find", u8"�����", FindSticker, FindBuf, 128);
									X1Gui().ListBoxHeader(XorStr("##StickerSerials"), Vec2(376, 340));
