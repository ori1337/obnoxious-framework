		...
		for (auto &v : It)
		{
			...
			if (SaveSticker)
			{
				...
				for (int i(0); i < 5; i++)
				{
					...
					SV(sname, string(XorStr("Sticker") + to_string(i) + XorStr("kit")), v.Skin.Stickers[i].kit);
					SV(sname, string(XorStr("Sticker") + to_string(i) + XorStr("kit_menu_index")), v.Skin.Stickers[i].kit_menu_index);
					SV(sname, string(XorStr("Sticker") + to_string(i) + XorStr("rotation")), v.Skin.Stickers[i].rotation);
					SV(sname, string(XorStr("Sticker") + to_string(i) + XorStr("scale")), v.Skin.Stickers[i].scale);
					SV(sname, string(XorStr("Sticker") + to_string(i) + XorStr("wear")), v.Skin.Stickers[i].wear);
				}
			}
		}
	};
