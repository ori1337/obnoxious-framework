...
void CGSettings::Menu()
{
	...
	string SettignBaseDir = CGlobal::SystemDisk + XorStr("obnoxious framework\\Configurations\\");
	string SettingsFormat = XorStr(".json");

	if (X1Gui().Button(!MainSettings().Russian ? XorStr("Create & save new config") : XorStr(u8"������� � ��������� ����� ���������")))
	{
		if (!CheckRus(string(NewConfigName)))
		{
			...
			if (Save(ConfigFileName + SettingsFormat))
				Message::Get().Start(!MainSettings().Russian ? XorStr("Config saved") : XorStr(u8"��������� ���������!"));
			else
				Message::Get().Start(!MainSettings().Russian ? XorStr("Save error") : XorStr(u8"������ ����������!"));
	...
	X1Gui().SameLine();
	if (X1Gui().Button(!MainSettings().Russian ? XorStr("Load shared config") : XorStr(u8"��������� ����� ���������")))
	{
		...
		if (!_shared_finded && !string(NewConfigHash).empty() && CloudLoad(string(NewConfigHash), _shared_name))
		{
			...
			UpdateList();
			Message::Get().Start(!MainSettings().Russian ? XorStr("Config loaded") : XorStr(u8"��������� ���������!"));
		}
		else
			Message::Get().Start(!MainSettings().Russian ? XorStr("Load error") : XorStr(u8"������ ��������!"));
	}
	...
	if (ConfigSelect >= 0 && ConfigSelect < (int)AllSettings.size())
	{
		if (!AllSettings[ConfigSelect].cloud && !AllSettings[ConfigSelect].pc_cloud)
		{
			...
			X1Gui().Separator();
			X1Gui().Spacing();
			if (X1Gui().Button(!MainSettings().Russian ? XorStr("Upload config to the server") : XorStr(u8"��������� ��������� �� ������"), Vec2(long_item_w, 0)))
			{
				string JCont = readFile(SettignBaseDir + AllSettings[ConfigSelect].name);

				if (JCont == string(XorStr("Read error")))
					Message::Get().Start(!MainSettings().Russian ? XorStr("Upload error") : XorStr(u8"������ ��������!"));
				else
				{
	...
	if (X1Gui().Button(!MainSettings().Russian ? XorStr("Update configs list") : XorStr(u8"�������� ������ ��������"), Vec2(long_item_w, 0)))
	{
		UpdateList();
	...
	if (X1Gui().Button(!MainSettings().Russian ? XorStr("Save config") : XorStr(u8"��������� ���������"), Vec2(long_item_w, 0)))
	{
		if (ConfigSelect >= 0 && ConfigSelect < (int)AllSettings.size())
		{
	...
	X1Gui().Spacing();
	if (X1Gui().Button(!MainSettings().Russian ? XorStr("Load config") : XorStr(u8"��������� ���������"), Vec2(long_item_w, 0)))
	{
		if (ConfigSelect >= 0 && ConfigSelect < (int)AllSettings.size())
		{
			SetName(SettignBaseDir + AllSettings[ConfigSelect].name);
	...
	X1Gui().Separator();
	X1Gui().Spacing();
	if (X1Gui().Button(!MainSettings().Russian ? XorStr("Delete config") : XorStr(u8"������� ���������"), Vec2(long_item_w, 0)))
	{
		if (ConfigSelect >= 0 && ConfigSelect < (int)AllSettings.size())
		{
			...
			UpdateList();
			Message::Get().Start(!MainSettings().Russian ? XorStr("Config deleted") : XorStr(u8"��������� �������!"));
		}
	}
