...
void CGHelper::Menu()
{
	...
	X1Gui().Separator();
	X1Gui().Spacing();
	if (X1Gui().Button(!MainSettings().Russian ? XorStr("Load") : XorStr(u8"��������� ��������"), Vec2(228, 22)))
	{
		if (LoadMaps());
	}
	X1Gui().SameLine();
	if (X1Gui().Button(!MainSettings().Russian ? XorStr("Save") : XorStr(u8"��������� ��������"), Vec2(228, 22)))
	{
		if (SaveMaps());
	}
	X1Gui().Spacing();
	X1Gui().Separator();
	X1Gui().Spacing();
	if (X1Gui().Button(!MainSettings().Russian ? XorStr("Reset") : XorStr(u8"�������� ��������� ��������"), Vec2(long_item_w, 22)))
	{
		maps.clear();
		SelectedGHInf = nullptr;
		SelectedMap = nullptr;
